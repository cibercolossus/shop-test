<div class="grid grid-cols-4 gap-4">
    @if ($compras > 0)
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg col-span-4 py-5 px-3">
            <div class="flex space-x-2">
                <div>
                    <button type="button" wire:click='processPurchases()'
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg p-3">
                        <h3 class="px-3 py-1 text-left text-sm font-medium text-gray-700 uppercase">Cliente: {{ $cliente }}</h3>
                        <h3 class="px-3 py-1 text-left text-sm font-medium text-gray-700 uppercase">Total Impuestos ${{ $impuestos }}</h3>
                        <h3 class="px-3 py-1 text-left text-sm font-medium text-gray-700 uppercase">Total ${{ $total }}</h3>
